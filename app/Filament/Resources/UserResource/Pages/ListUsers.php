...
class ListUsers extends ListRecords
{
    ...
    public function getTabs(): array
    {
        ...
        $tabs = [
            null => Tab::make('All'),
            'admins' => Tab::make()->query(fn ($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'admin')),
            'christians' => Tab::make()->query(fn ($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'christian')),
            'pastors' => Tab::make()->query(fn ($query) => $query->with('roles')->whereRelation('roles', 'name', '=', 'pastor')),
        ];
